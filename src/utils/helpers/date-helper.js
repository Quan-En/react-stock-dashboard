...
export const convertDateToUnixTimestamp = (date) => {
  ...
  export const convertUnixTimestampToFormatDate = (unixTimestamp) => {
    const milliseconds = unixTimestamp * 1000;
    const date_ = new Date(milliseconds);
    const year = date_.toLocaleString('en-US', {year: 'numeric'});
    const month = date_.toLocaleString('en-US', {month: '2-digit',});
    const day = date_.toLocaleString('en-US', {day: '2-digit'});
